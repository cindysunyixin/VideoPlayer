...
function playOrPause() {
	if (video.paused) {
		video.play();
		playButton.src = 'Desktop/pause.png';
		update = setInterval(updatePlayer, 30);

		pauseScreen.style.display = 'none';
		screenButton.src = 'Desktop/play.png';
	} else {
		video.pause();
		playButton.src = 'Desktop/play.png';
...
function updatePlayer() {
	...
	if (video.ended) {
		window.clearInterval(update);
		playButton.src = 'Desktop/replay.png';

		pauseScreen.style.display = 'block';
		screenButton.src = 'Desktop/replay.png';
...
function muteOrUnmute() {
	if (!video.muted) {
		video.muted = true;
		soundButton.src = 'Desktop/mute.png';
		sbar.style.display = 'none';
	} else {
		video.muted = false;
		soundButton.src = 'Desktop/sound.png';
